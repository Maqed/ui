  ...
  return (
    <div className="grid w-full max-w-xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
      <div className="space-y-2">
        <p className="truncate text-xs text-muted-foreground">Shimmer</p>
      ...
      <div className="space-y-2">
        <p className="truncate text-xs text-muted-foreground">Pulse</p>
        <div className="shadow-panel space-y-3 rounded-lg bg-transparent p-4">
      ...
      <div className="space-y-2">
        <p className="truncate text-xs text-muted-foreground">None</p>
        <div className="shadow-panel space-y-3 rounded-lg bg-transparent p-4">
